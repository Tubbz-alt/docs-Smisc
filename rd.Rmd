...
<code><a href=http://www.inside-r.org/packages/cran/utils/docs/data>data</a></code>,<code><a href=#loadobject>loadObject</a></code>,<code><a href=http://www.inside-r.org/packages/cran/utils/docs/read.table>read.csv</a></code>
...
<code><a href=http://www.inside-r.org/packages/cran/stats/docs/complete.cases>complete.cases</a></code>
...
<code><a href=http://www.inside-r.org/packages/cran/base/docs/all.equal>all.equal</a></code>, <code><a href=http://www.inside-r.org/packages/cran/base/docs/identical>identical</a></code>
...
<p class="rd-p">A wrapper for <code><a href='http://www.inside-r.org/packages/cran/base/docs/cbind'>rbind</a></code> and <code><a href='http://www.inside-r.org/packages/cran/base/docs/cbind'>cbind</a></code> to quickly bind
numerous objects together at once using a single call to <code><a href='http://www.inside-r.org/packages/cran/base/docs/cbind'>rbind</a></code> or
 <code><a href='http://www.inside-r.org/packages/cran/base/docs/cbind'>cbind</a></code>. This function is most helpful when there are
...
<dl class="rd-dl">
  ...
  <dt>type</dt>
  <dd class="rd-dd">The type of binding, "row" for <code><a href=http://www.inside-r.org/packages/cran/base/docs/cbind>rbind</a></code> or "col" for
<code><a href=http://www.inside-r.org/packages/cran/base/docs/cbind>cbind</a></code>, and "c" for concatenating using <code><a href=http://www.inside-r.org/packages/cran/base/docs/c>c</a></code>.  Defaults to
"row".</dd>
</dl>
...
<code><a href=http://www.inside-r.org/packages/cran/base/docs/cbind>rbind</a></code>
...
<code><a href=#list2df>list2df</a></code>, <code><a href=http://www.inside-r.org/packages/cran/base/docs/list>as.list</a></code>
...
via <code><a href=http://www.inside-r.org/packages/cran/base/docs/as.data.frame>as.data.frame</a></code> and the resulting data frames must have the
...
<code><a href=http://www.inside-r.org/packages/cran/base/docs/numeric>as.numeric</a></code>
...
<code><a href=#getpath>getPath</a></code>, <code><a href=#grablast>grabLast</a></code>, <code><a href=http://www.inside-r.org/packages/cran/base/docs/basename>basename</a></code>, <code><a href=http://www.inside-r.org/packages/cran/base/docs/basename>dirname</a></code>
...
<code><a href=#strippath>stripPath</a></code>, <code><a href=#grablast>grabLast</a></code>, <code><a href=http://www.inside-r.org/packages/cran/base/docs/basename>basename</a></code>, <code><a href=http://www.inside-r.org/packages/cran/base/docs/basename>dirname</a></code>
...
Additional functions for filename manipulations:  <code><a href=#stripextension>stripExtension</a></code>, <code><a href=#getextension>getExtension</a></code>,
<code><a href=#strippath>stripPath</a></code>, <code><a href=#getpath>getPath</a></code>, <code><a href=http://www.inside-r.org/packages/cran/base/docs/basename>basename</a></code>, <code><a href=http://www.inside-r.org/packages/cran/base/docs/basename>dirname</a></code>
...
(<code>FALSE</code>)</dd>
  <dt>...</dt>
  <dd class="rd-dd">Additional arguments to <code><a href=http://www.inside-r.org/packages/cran/base/docs/cat>cat</a></code></dd>
</dl>

  <h4>Value</h4>

  <p class="rd-p">Prints code (via <code><a href=http://www.inside-r.org/packages/cran/base/docs/cat>cat</a></code>) that will create the vector.  This code
...
to the <code>n</code> argument of <code><a href=http://www.inside-r.org/packages/cran/base/docs/readLines>readLines</a></code>. The default is <code>-1</code>,
...
<code><a href=http://www.inside-r.org/packages/cran/base/docs/readLines>readLines</a></code>
...
is passed to the <code>digits</code> argument of <code><a href=http://www.inside-r.org/packages/cran/base/docs/Round>round</a></code>.</dd>
  <dt>abbrev</dt>
...
<code>FALSE</code>, <code>sourceDir</code> will stop if a file sources with an error.</dd>
  <dt>...</dt>
  <dd class="rd-dd">Additional arguments to <code><a href=http://www.inside-r.org/packages/cran/base/docs/source>source</a></code></dd>
</dl>
...
<p class="rd-p">A more flexible version of <code><a href='http://www.inside-r.org/packages/cran/base/docs/stopifnot'>stopifnot</a></code> that allows you to control the error message returned by
...
See examples.</dd>
  ...
  <p class="rd-p">A call to <code><a href=http://www.inside-r.org/packages/cran/base/docs/stop>stop</a></code> with the error messages from each condition that was <code>FALSE</code>.  If all
...
<p class="rd-p">A wrapper to make calls to <code><a href='http://www.inside-r.org/packages/cran/parallel/docs/clusterApply'>parLapply</a></code> easier by initializing the cluster, exporting objects and expressions to the
...
<dl class="rd-dl">
  ...
  <dt>expr</dt>
  <dd class="rd-dd">An expression that will be evaluated on each worker node via a call to <code><a href=http://www.inside-r.org/packages/cran/parallel/docs/clusterApply>clusterEvalQ</a></code></dd>
  <dt>varlist</dt>
  <dd class="rd-dd">Character vector of names of objects to export to each worker node via <code><a href=http://www.inside-r.org/packages/cran/parallel/docs/clusterApply>clusterExport</a></code></dd>
  <dt>envir</dt>
...
<code><a href=http://www.inside-r.org/packages/cran/base/docs/lapply>lapply</a></code>, <code><a href=http://www.inside-r.org/packages/cran/parallel/docs/clusterApply>parLapply</a></code>, <code><a href=#plapply>plapply</a></code>
...
<p class="rd-p">Parses a large list into subsets and submits a separate batch R job that calls <code><a href='http://www.inside-r.org/packages/cran/base/docs/lapply'>lapply</a></code>
on the  subset.  <code>plapply</code> has some features that may not be readily available in
other parallelization functions like <code><a href='http://www.inside-r.org/packages/cran/parallel/docs/mclapply'>mclapply</a></code> and <code><a href='http://www.inside-r.org/packages/cran/parallel/docs/clusterApply'>parLapply</a></code>:
<ul>
...
before and after the call to <code><a href='http://www.inside-r.org/packages/cran/base/docs/lapply'>lapply</a></code></li>
</ul>
...
loaded in each new instance of R, using <code><a href=http://www.inside-r.org/packages/cran/base/docs/library>library</a></code>.</dd>
  <dt>header.file</dt>
  <dd class="rd-dd">Text string indicating a file that will be initially
sourced prior calling <code><a href=http://www.inside-r.org/packages/cran/base/docs/lapply>lapply</a></code> in order to create an
...
and then applies <code>FUN</code> to each sublist using <code><a href=http://www.inside-r.org/packages/cran/base/docs/lapply>lapply</a></code>.</p>
...
<code>needed.objects</code></p>
  ...
  <p class="rd-p"></li>
<li> <code><a href=http://www.inside-r.org/packages/cran/base/docs/lapply>lapply</a></code> is called on the sublist, the sublist is called
<code>X.i</code></p>
...
<code><a href=#parlapplyw>parLapplyW</a></code>, <code><a href=#dfplapply>dfplapply</a></code>, <code><a href=http://www.inside-r.org/packages/cran/parallel/docs/clusterApply>parLapply</a></code>, <code><a href=http://www.inside-r.org/packages/cran/parallel/docs/mclapply>mclapply</a></code>
...
supplied to <code>.paropts</code> is ignored. See the documentation for <code><a href=http://www.inside-r.org/packages/cran/plyr/docs/ddply>plyr::ddply</a></code> for additional details.</p>
  ...
  <p class="rd-p">The object data frame returned by <code><a href=http://www.inside-r.org/packages/cran/plyr/docs/ddply>plyr::ddply</a></code></p>
...
no randomization is performed.</dd>
  ...
  <p class="rd-p">This function is a parallelized wrapper for <code><a href=http://www.inside-r.org/packages/cran/base/docs/do.call>do.call</a></code> designed for the case where <code>fun</code> is
...
<code><a href='http://www.inside-r.org/packages/cran/grDevices/docs/postscript'>postscript</a></code>, <code><a href='http://www.inside-r.org/packages/cran/grDevices/docs/pdf'>pdf</a></code>, <code><a href='http://www.inside-r.org/packages/cran/grDevices/docs/png'>jpeg</a></code>,
<code><a href='http://www.inside-r.org/packages/cran/grDevices/docs/png'>tiff</a></code>, <code><a href='http://www.inside-r.org/packages/cran/grDevices/docs/png'>png</a></code>, or <code><a href='http://www.inside-r.org/packages/cran/grDevices/docs/png'>bmp</a></code>.</p>
...
and plotted, just as in <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/plot.default>plot.default</a></code> in the <span class = "pkg">graphics</span> package.</dd>
  <dt>col</dt>
  <dd class="rd-dd">A vector of colors to use in the plotting. Its length should match the length of <code>fun</code>. See <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/par>par</a></code> for
more info about the <code>col</code> graphics parameter.</dd>
  <dt>lty</dt>
  <dd class="rd-dd">A vector of line types to use in the plotting. Its length should match the length of <code>fun</code>. See <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/par>par</a></code> for
...
<code><a href=http://www.inside-r.org/packages/cran/graphics/docs/plot.default>plot.default</a></code>.</dd>
  <dt>legendLabels</dt>
  <dd class="rd-dd">A character vector with descriptive names that will appear in the legend, corresponding to each function
If <code>NULL</code>, no legend is drawn. This character vector is passed to the <code>legend</code> argument in <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/legend>legend</a></code>
from the <span class = "pkg">graphics</span> package.</dd>
  ...
  <dt>...</dt>
  <dd class="rd-dd">Additional graphical arguments passed to <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/plot.default>plot.default</a></code>, <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/lines>lines</a></code>, and
<code><a href=http://www.inside-r.org/packages/cran/graphics/docs/legend>legend</a></code>.  If an argument name specified in <code>...</code> matches an argument name in any
of these three functions, the argument is passed to that function.
For example, the line width, <code>lwd</code>, would be passed to all three (<code><a href=http://www.inside-r.org/packages/cran/graphics/docs/plot.default>plot.default</a></code>, <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/lines>lines</a></code>, and
<code><a href=http://www.inside-r.org/packages/cran/graphics/docs/legend>legend</a></code>).</dd>
</dl>
...
presumed to be ordered chronologically</dd>
  ...
  <dt>side</dt>
  <dd class="rd-dd">Same as the <code>side</code> argument in <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/axis>axis</a></code></dd>
  <dt>time.format</dt>
...
<code><a href=http://www.inside-r.org/packages/cran/graphics/docs/axis.POSIXct>axis.POSIXct</a></code>
...
single value.</dd>
  <dt>...</dt>
  <dd class="rd-dd">additional arguments to <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/lines>lines</a></code>.</dd>
</dl>
...
<code><a href=http://www.inside-r.org/packages/cran/stats/docs/Binomial>dbinom</a></code>, <code><a href=http://www.inside-r.org/packages/cran/stats/docs/Binomial>pbinom</a></code>
...
as <code>log(p)</code>.</dd>
  ...
  <p class="rd-p"><code>pcbinom</code> is equivalent to <code><a href=http://www.inside-r.org/packages/cran/stats/docs/Binomial>pbinom</a></code> for integer values of
...
<code><a href=http://www.inside-r.org/packages/cran/stats/docs/Binomial>pbinom</a></code>, <code><a href=http://www.inside-r.org/packages/cran/stats/docs/Beta>pbeta</a></code>
...
<code><a href=#plotfun>plotFun</a></code>, <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/plot.default>plot.default</a></code>, or <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/abline>abline</a></code></dd>
</dl>
...
non-missing value occur on or after the center point of the window.</dd>
  ...
  <p class="rd-p"><code>smartFilter</code> has very similar behavior to <code><a href=http://www.inside-r.org/packages/cran/stats/docs/filter>filter</a></code>,
...
<code><a href=#movavg2>movAvg2</a></code>, <code><a href=http://www.inside-r.org/packages/cran/stats/docs/filter>filter</a></code>
...
<code><a href=http://www.inside-r.org/packages/cran/base/docs/print.default>print.default</a></code> and <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/plot.default>plot.default</a></code>, respectively.</dd>
  <dt>x</dt>
...
<code><a href=#smartfilter>smartFilter</a></code>, <code><a href=http://www.inside-r.org/packages/cran/stats/docs/filter>filter</a></code>
...
<dl class="rd-dl">
  ...
  <dt>...</dt>
  <dd class="rd-dd">Additional arguments to <code><a href=http://www.inside-r.org/packages/cran/base/docs/print.default>print.default</a></code> or <code><a href=http://www.inside-r.org/packages/cran/graphics/docs/plot.default>plot.default</a></code>.  Ignored by the <code>signal</code> method.</dd>
  <dt>indexes</dt>
...
calculating the combinations, using <code><a href=http://www.inside-r.org/packages/cran/parallel/docs/clusterApply>parLapply</a></code></dd>
</dl>

  <h4>Details</h4>

  <p class="rd-p">Uses <code><a href=http://www.inside-r.org/packages/cran/utils/docs/combn>combn</a></code> to identify the combinations.</p>
...
<code><a href=http://www.inside-r.org/packages/cran/base/docs/cumsum>cumsum</a></code>
...
the way <code><a href=http://www.inside-r.org/packages/cran/base/docs/duplicated>duplicated</a></code> identifies duplicates. As such, the first
...
produced by <code><a href=http://www.inside-r.org/packages/cran/base/docs/qr>qr</a></code>, and if not equal, a warning is issued.  The
value of <code>tol</code> is passed to <code><a href=http://www.inside-r.org/packages/cran/base/docs/qr>qr</a></code>, but the criteria of
convergence for <code><a href=http://www.inside-r.org/packages/cran/base/docs/qr>qr</a></code> is assuredly different from that used here
