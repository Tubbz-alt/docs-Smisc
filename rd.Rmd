...
<dl class="rd-dl">
  ...
  <dt>...</dt>
  <dd class="rd-dd">Additional arguments to <code><a href=http://www.inside-r.org/r-doc/base/print.default>print.default</a></code></dd>
</dl>
...
given by the log-likelihood ratio, in which case <code>k = 0</code> would make sense.</p>
  ...
  <p class="rd-p">Plot method to come...</p>
...
CUSUM resets.
  ...
  <p class="rd-p"><ul>
<li> <code>print</code>: Prints the <code>cusum</code> object by only showing the CUSUM statistics and suppressing the attributes.
</li>
</ul></p>
